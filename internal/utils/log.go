...
const (
	...
	LogLevelDebug
	// LogLevelDebug enables debug logs and FEC logs
	LogLevelDebugFEC
)
...
func DebugfFEC(format string, args ...interface{}) {
	if logLevel == LogLevelDebugFEC  || logLevel == LogLevelDebug{
