...
func (s *server) serve() {
	for {
		...
		//PABLO
		//data2 := *getPacketBuffer()
		//data2 = data2[:(protocol.MaxReceivePacketSize)]
		//typeByte := data[0]
		//if typeByte == 0x80{
		//	fmt.Printf("FEC Packet Received!!!!!\n")
		//	continue
		//} else if(typeByte == 0x02){
		//	fmt.Printf("Received NORMAL packet: %d\n", n)
		//	copy(data2,data[1:n])
		//	n = n-1
		//	data2 = data2[:n]
		//}else{
		...
		//fmt.Printf("Cap: %d, Len: %d", cap(data2), len(data2))
